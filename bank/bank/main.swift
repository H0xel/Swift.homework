...
let creditProduct1 = bank.createCreditProduct(user: client1)
let depositProduct1 = bank.createDepositProduct(user: client1)

let testCreditProduct = bank.createCreditProduct(user: testclient1)

bank.store(client: client1)

//bank.store(client: client2)

//bank.store(product: creditProduct1, user: client1)
//bank.store(product: depositProduct1, user: client1)
