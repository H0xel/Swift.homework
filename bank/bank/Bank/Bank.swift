...
extension BankImpl: Bank {
    ...
    func getPreferences(user: User) -> ProductPreferences? {
        return preferenceService.getPreferences(user: user)
    }
    
    func set(preferences: ProductPreferences, user: User) {
        preferenceService.set(preferences: preferences, user: user)
    }
    ...
    func createDepositProduct(user: User) -> Product {
        ...
        preferenceService.set(preferences: ProductPreferences(productReceiverID: product.id, productSenderID: product.id), user: user)
