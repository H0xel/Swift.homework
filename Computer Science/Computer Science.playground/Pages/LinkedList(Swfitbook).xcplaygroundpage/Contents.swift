...
// чаще всег оиспользуется в виде очередей

//index           0         1          2           3         4
//array:     [element 1][element 2][element 3][element 4][element 5]

//Big O notation - отображение сложности того или иного алгоритма
...
indirect enum LinkedListNode<T> { // indirect - использования типа "LinkedList" внутри себя
